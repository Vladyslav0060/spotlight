...
const ContentForm: React.FC = () => {
  ...
  const onInputChange = (e: any) => {
    ...
    const sorted = users.filter((user: IUser) => {
      return (
        user.name
          .toLocaleLowerCase()
  ...
  return (
    <div className="wrapper-content">
      <div className="flex flex-no-wrap h-full">
        <div className="w-80 absolute sm:relative bg-slate-50 shadow md:h-full flex-col justify-between hidden sm:flex rounded-tl-xl rounded-bl-xl">
          <div className="px-4" style={{ overflow: "scroll" }}>
            <div className=" flex justify-left h-12 w-full flex items-center border-b-1">
              <div className="relative ">
                <div className="text-gray-500 absolute ml-0 inset-0 m-auto w-4 h-4 ">
                  <svg
                ...
                <input
                  className="focus:outline-none rounded w-full text-sm text-gray-500 pl-7 py-2"
                  type="text"
                  placeholder="Search"
        ...
        <div className="container h-100  w-11/12">
          <div className="w-full h-full border-1 border-gray-300 bg-slate-50 flex items-top rounded-r-xl">
